...
export const WaiversPage = () => {
	...
	if (league.isLoading || waiverTeams.isLoading || waiverPriority.isLoading) {
	...
	return (
		<div className="space-y-4">
			<div className="flex gap-2">
				<Button variant={activeTab === "teams" ? "default" : "outline"} onClick={() => setActiveTab("teams")}>
					Teams on Waivers
				</Button>
				<Button variant={activeTab === "priority" ? "default" : "outline"} onClick={() => setActiveTab("priority")}>
					Waiver Priority
				</Button>
			</div>
